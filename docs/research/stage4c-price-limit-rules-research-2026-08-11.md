...
- `docs/plan/archive/completed/invest-infra-stage4c-core-data-layer-integration-plan.md` §3.3、§4.3、§7：已有 `stock_price_limits` 候选 dataset、`prev_close`/限制价/命中字段和 `rule_version/source_refs` 设计。
