"""Tonghuashun (同花顺) adapter package (three-provider plan, Phase 1).

Phase 1 of the V2 three-provider plan
(``tasks/plan-data-source-three-provider.md``) freezes the catalog
declaration and ships the configuration skeleton for the Tonghuashun
adapter. The catalog entry
:data:`invest_pipeline.provider_catalog.TONGHUASHUN` records the
