"""Sina (新浪) adapter package (three-provider plan, Phase 1).

Phase 1 of the V2 three-provider plan
(``tasks/plan-data-source-three-provider.md``) freezes the catalog
declaration and ships the configuration skeleton for the Sina adapter.
The catalog entry
:data:`invest_pipeline.provider_catalog.SINA` records the
