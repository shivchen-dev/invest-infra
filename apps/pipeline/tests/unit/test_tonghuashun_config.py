"""Unit tests for :class:`invest_pipeline.adapters.tonghuashun.config.TonghuashunSettings`.

Phase 1 of the V2 three-provider plan
(``tasks/plan-data-source-three-provider.md``) freezes the Tonghuashun
...
from invest_pipeline.adapters.tonghuashun.config import TonghuashunSettings


class TonghuashunSettingsDefaultsTest(unittest.TestCase):
...
class TonghuashunSettingsRedactionTest(unittest.TestCase):
    ...
    def test_redacted_dict_exposes_every_field(self) -> None:
        ...
        view = TonghuashunSettings().redacted_dict()
    ...
    def test_redacted_dict_reflects_overrides(self) -> None:
        ...
        settings = TonghuashunSettings(enabled=True)
        view = settings.redacted_dict()
        self.assertEqual(view["enabled"], "True")


class TonghuashunSettingsImportSafetyTest(unittest.TestCase):
    ...
    def test_importing_config_does_not_import_httpx(self) -> None:
        ...
        import invest_pipeline.adapters.tonghuashun.config as config_module
