...
class MarketTemperatureObservationResponse(BaseModel):
    observation_key: str
...
class MarketTemperatureResponse(BaseModel):
    ...
    content_hash: str
    observations: list[MarketTemperatureObservationResponse]

    @classmethod
    def from_domain(cls, snapshot: MarketObservationSnapshot) -> MarketTemperatureResponse:
        return cls(
